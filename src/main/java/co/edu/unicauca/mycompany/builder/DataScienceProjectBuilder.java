...
/**
 * Clase concreta DataScienceProjectBuilder.
 * 
 * Implementa el patrón de diseño Builder para construir instancias de Project 
 * especializadas en proyectos de ciencia de datos.
 */
public class DataScienceProjectBuilder extends ProjectBuilder {
     ...
     * 
     * En los proyectos de ciencia de datos, la dificultad predeterminada es "Mediana".
     */
    @Override
    public void buildDifficulty() {
        this.difficulty = "Mediana";
    }
}
