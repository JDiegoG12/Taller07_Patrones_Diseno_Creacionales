...
/**
 * Clase concreta EmbeddedSystemsProjectBuilder.
 * 
 * Implementa el patrón de diseño Builder para construir instancias de Project 
 * especializadas en proyectos de sistemas embebidos.
 */
public class EmbeddedSystemsProjectBuilder extends ProjectBuilder {
     ...
     * 
     * En los proyectos de sistemas embebidos, la dificultad predeterminada es "Alta".
     */
    @Override
